...
/ /   = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =  
 / /   I D   P R O O F   M A N A G E M E N T  
 / /   = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =  
  
 / /   T e m p o r a r y   s t o r a g e   f o r   u p l o a d e d   f i l e  
 w i n d o w . u p l o a d e d F i l e D a t a   =   n u l l ;  
 w i n d o w . i s U p l o a d i n g   =   f a l s e ;   / /   T r a c k   u p l o a d   s t a t u s  
  
 f u n c t i o n   h a n d l e F i l e U p l o a d ( i n p u t )   {  
         c o n s t   f i l e   =   i n p u t . f i l e s [ 0 ] ;  
         c o n s t   p a r e n t   =   i n p u t . p a r e n t N o d e ;  
         c o n s t   e x i s t i n g S t a t u s   =   p a r e n t . q u e r y S e l e c t o r ( ' . u p l o a d - s t a t u s ' ) ;  
         i f   ( e x i s t i n g S t a t u s )   e x i s t i n g S t a t u s . r e m o v e ( ) ;  
  
         i f   ( ! f i l e )   {  
                 w i n d o w . u p l o a d e d F i l e D a t a   =   n u l l ;  
                 w i n d o w . i s U p l o a d i n g   =   f a l s e ;  
                 r e t u r n ;  
         }  
  
         / /   C h e c k   f i l e   s i z e   ( 5 M B   l i m i t )  
         i f   ( f i l e . s i z e   >   5   *   1 0 2 4   *   1 0 2 4 )   {  
                 a l e r t ( ' F i l e   s i z e   m u s t   b e   l e s s   t h a n   5 M B ' ) ;  
                 i n p u t . v a l u e   =   ' ' ;  
                 w i n d o w . u p l o a d e d F i l e D a t a   =   n u l l ;  
                 w i n d o w . i s U p l o a d i n g   =   f a l s e ;  
                 r e t u r n ;  
         }  
  
         w i n d o w . i s U p l o a d i n g   =   t r u e ;  
  
         / /   S h o w   p r o c e s s i n g   m e s s a g e  
         c o n s t   p r o c e s s i n g S t a t u s   =   d o c u m e n t . c r e a t e E l e m e n t ( ' d i v ' ) ;  
         p r o c e s s i n g S t a t u s . c l a s s N a m e   =   ' u p l o a d - s t a t u s ' ;  
         p r o c e s s i n g S t a t u s . s t y l e . c o l o r   =   ' # f b b f 2 4 ' ;   / /   W a r n i n g   y e l l o w  
         p r o c e s s i n g S t a t u s . s t y l e . f o n t S i z e   =   ' 0 . 8 7 5 r e m ' ;  
         p r o c e s s i n g S t a t u s . s t y l e . m a r g i n T o p   =   ' 0 . 2 5 r e m ' ;  
         p r o c e s s i n g S t a t u s . t e x t C o n t e n t   =   ' � � �   P r o c e s s i n g   f i l e . . . ' ;  
         p a r e n t . a p p e n d C h i l d ( p r o c e s s i n g S t a t u s ) ;  
  
         / /   R e a d   f i l e   a s   b a s e 6 4  
         c o n s t   r e a d e r   =   n e w   F i l e R e a d e r ( ) ;  
         r e a d e r . o n l o a d   =   f u n c t i o n   ( e )   {  
                 w i n d o w . u p l o a d e d F i l e D a t a   =   {  
                         n a m e :   f i l e . n a m e ,  
                         t y p e :   f i l e . t y p e ,  
                         s i z e :   f i l e . s i z e ,  
                         d a t a :   e . t a r g e t . r e s u l t ,  
                         u p l o a d D a t e :   n e w   D a t e ( ) . t o I S O S t r i n g ( )  
                 } ;  
                 w i n d o w . i s U p l o a d i n g   =   f a l s e ;  
  
                 / /   U p d a t e   s t a t u s   t o   s u c c e s s  
                 i f   ( p r o c e s s i n g S t a t u s   & &   p r o c e s s i n g S t a t u s . p a r e n t N o d e )   {  
                         p r o c e s s i n g S t a t u s . s t y l e . c o l o r   =   ' # 4 a d e 8 0 ' ;   / /   S u c c e s s   g r e e n  
                         p r o c e s s i n g S t a t u s . t e x t C o n t e n t   =   ' � S&   F i l e   r e a d y   t o   s a v e ' ;  
                 }  
         } ;  
         r e a d e r . o n e r r o r   =   f u n c t i o n   ( )   {  
                 w i n d o w . i s U p l o a d i n g   =   f a l s e ;  
                 i f   ( p r o c e s s i n g S t a t u s   & &   p r o c e s s i n g S t a t u s . p a r e n t N o d e )   {  
                         p r o c e s s i n g S t a t u s . s t y l e . c o l o r   =   ' # e f 4 4 4 4 ' ;   / /   E r r o r   r e d  
                         p r o c e s s i n g S t a t u s . t e x t C o n t e n t   =   ' � � R  E r r o r   r e a d i n g   f i l e ' ;  
                 }  
                 a l e r t ( ' E r r o r   r e a d i n g   f i l e ' ) ;  
         } ;  
         r e a d e r . r e a d A s D a t a U R L ( f i l e ) ;  
 }  
  
 f u n c t i o n   s h o w P r o o f s P a g e ( b u i l d i n g I d )   {  
         c o n s t   b u i l d i n g   =   b u i l d i n g s D a t a [ b u i l d i n g I d ] ;  
         c o n s t   c u s t o m e r s W i t h P r o o f s   =   b u i l d i n g . c u s t o m e r s . f i l t e r ( c   = >   c . i d P r o o f ) ;  
  
         c o n s t   c o n t e n t   =   d o c u m e n t . g e t E l e m e n t B y I d ( ' d y n a m i c - c o n t e n t ' ) ;  
  
         c o n t e n t . i n n e r H T M L   =   `  
                 < d i v   c l a s s = " p a g e - c o n t a i n e r " >  
                         < d i v   c l a s s = " c o n t a i n e r " >  
                                 < d i v   c l a s s = " p a g e - h e a d e r " >  
                                         < h 1   c l a s s = " p a g e - t i t l e " >  
                                                 < b u t t o n   c l a s s = " b a c k - b u t t o n "   o n c l i c k = " g o B a c k ( ) " >  
                                                         < s v g   v i e w B o x = " 0   0   2 4   2 4 "   f i l l = " n o n e "   x m l n s = " h t t p : / / w w w . w 3 . o r g / 2 0 0 0 / s v g " >  
                                                                 < p a t h   d = " M 1 9   1 2 H 5 "   s t r o k e = " c u r r e n t C o l o r "   s t r o k e - w i d t h = " 2 " / >  
                                                                 < p a t h   d = " M 1 2   1 9 L 5   1 2 L 1 2   5 "   s t r o k e = " c u r r e n t C o l o r "   s t r o k e - w i d t h = " 2 " / >  
                                                         < / s v g >  
                                                 < / b u t t o n >  
                                                 < s p a n > I D   P r o o f s   -   $ { b u i l d i n g . n a m e } < / s p a n >  
                                         < / h 1 >  
                                         < p   c l a s s = " p a g e - s u b t i t l e " > V i e w   c u s t o m e r   i d e n t i f i c a t i o n   d o c u m e n t s < / p >  
                                 < / d i v >  
                                  
                                 < d i v   c l a s s = " t a b l e - c o n t a i n e r " >  
                                         < d i v   c l a s s = " t a b l e - h e a d e r " >  
                                                 < h 3   c l a s s = " t a b l e - t i t l e " > C u s t o m e r   I D   P r o o f s < / h 3 >  
                                         < / d i v >  
                                         $ { c u s t o m e r s W i t h P r o o f s . l e n g t h   >   0   ?   `  
                                                 < t a b l e >  
                                                         < t h e a d >  
                                                                 < t r >  
                                                                         < t h > C u s t o m e r   N a m e < / t h >  
                                                                         < t h > R o o m < / t h >  
...
                                                         < / t h e a d >  
                                                         < t b o d y >  
                                                                 $ { c u s t o m e r s W i t h P r o o f s . m a p ( c   = >   `  
                                                                         < t r >  
                                                                                 < t d > < s t r o n g > $ { c . n a m e } < / s t r o n g > < / t d >  
                                                                                 < t d > $ { c . r o o m } < / t d >  
                                                                                 < t d > $ { c . i d P r o o f . n a m e } < / t d >  
                                                                                 < t d >  
                                                                                         < b u t t o n   c l a s s = " b t n   b t n - p r i m a r y "   s t y l e = " p a d d i n g : 6 p x   1 2 p x ; f o n t - s i z e : 0 . 8 7 5 r e m "   o n c l i c k = " v i e w P r o o f ( $ { c . i d } ,   ' $ { b u i l d i n g I d } ' ) " > V i e w < / b u t t o n >  
                                                                                 < / t d >  
                                                                         < / t r >  
                                                                 ` ) . j o i n ( ' ' ) }  
                                                         < / t b o d y >  
                                                 < / t a b l e >  
                                         `   :   `  
                                                 < d i v   s t y l e = " t e x t - a l i g n : c e n t e r ; p a d d i n g : 3 r e m ; c o l o r : # 9 4 a 3 b 8 ; " >  
                                                         < h 3 > N o   I D   P r o o f s   U p l o a d e d < / h 3 >  
                                                         < p > A d d   c u s t o m e r s   w i t h   I D   p r o o f s   t o   s e e   t h e m   h e r e < / p >  
                                                 < / d i v >  
                                         ` }  
                                 < / d i v >  
                         < / d i v >  
...
         ` ;  
  
         c o n t e n t . s c r o l l I n t o V i e w ( {   b e h a v i o r :   ' s m o o t h '   } ) ;  
 }  
  
 f u n c t i o n   v i e w P r o o f ( c u s t o m e r I d ,   b u i l d i n g I d )   {  
         c o n s t   b u i l d i n g   =   b u i l d i n g s D a t a [ b u i l d i n g I d ] ;  
         c o n s t   c u s t o m e r   =   b u i l d i n g . c u s t o m e r s . f i n d ( c   = >   c . i d   = = =   c u s t o m e r I d ) ;  
  
         i f   ( ! c u s t o m e r   | |   ! c u s t o m e r . i d P r o o f )   {  
                 a l e r t ( ' N o   I D   p r o o f   f o u n d ' ) ;  
                 r e t u r n ;  
         }  
  
         c o n s t   m o d a l   =   d o c u m e n t . c r e a t e E l e m e n t ( ' d i v ' ) ;  
         m o d a l . c l a s s N a m e   =   ' m o d a l   a c t i v e ' ;  
  
         c o n s t   i s I m a g e   =   c u s t o m e r . i d P r o o f . t y p e . s t a r t s W i t h ( ' i m a g e / ' ) ;  
  
         m o d a l . i n n e r H T M L   =   `  
                 < d i v   c l a s s = " m o d a l - c o n t e n t "   s t y l e = " m a x - w i d t h :   9 0 % ; " >  
                         < d i v   c l a s s = " m o d a l - h e a d e r " >  
                                 < h 2   c l a s s = " m o d a l - t i t l e " > I D   P r o o f   -   $ { c u s t o m e r . n a m e } < / h 2 >  
                                 < b u t t o n   c l a s s = " m o d a l - c l o s e "   o n c l i c k = " t h i s . c l o s e s t ( ' . m o d a l ' ) . r e m o v e ( ) " > �  < / b u t t o n >  
                         < / d i v >  
                         < d i v   s t y l e = " p a d d i n g :   1 . 5 r e m ; " >  
                                 < d i v   s t y l e = " m a r g i n - b o t t o m :   1 r e m ;   p a d d i n g :   1 r e m ;   b a c k g r o u n d :   r g b a ( 1 0 0 ,   1 1 6 ,   1 3 9 ,   0 . 1 ) ;   b o r d e r - r a d i u s :   8 p x ; " >  
                                         < p   s t y l e = " m a r g i n :   0   0   0 . 5 r e m ;   c o l o r :   # c b d 5 e 1 ; " > < s t r o n g > C u s t o m e r : < / s t r o n g >   $ { c u s t o m e r . n a m e } < / p >  
                                         < p   s t y l e = " m a r g i n :   0   0   0 . 5 r e m ;   c o l o r :   # c b d 5 e 1 ; " > < s t r o n g > R o o m : < / s t r o n g >   $ { c u s t o m e r . r o o m } < / p >  
                                         < p   s t y l e = " m a r g i n :   0 ;   c o l o r :   # c b d 5 e 1 ; " > < s t r o n g > D o c u m e n t : < / s t r o n g >   $ { c u s t o m e r . i d P r o o f . n a m e } < / p >  
                                 < / d i v >  
                                 $ { i s I m a g e   ?   `  
                                         < i m g   s r c = " $ { c u s t o m e r . i d P r o o f . d a t a } "   s t y l e = " w i d t h :   1 0 0 % ;   h e i g h t :   a u t o ;   b o r d e r - r a d i u s :   8 p x ; "   a l t = " I D   P r o o f " >  
                                 `   :   `  
                                         < p   s t y l e = " t e x t - a l i g n :   c e n t e r ;   c o l o r :   # 9 4 a 3 b 8 ; " > P r e v i e w   n o t   a v a i l a b l e   f o r   t h i s   f i l e   t y p e < / p >  
                                         < p   s t y l e = " t e x t - a l i g n :   c e n t e r ;   m a r g i n - t o p :   1 r e m ; " > < a   h r e f = " $ { c u s t o m e r . i d P r o o f . d a t a } "   d o w n l o a d = " $ { c u s t o m e r . i d P r o o f . n a m e } "   c l a s s = " b t n   b t n - p r i m a r y " > D o w n l o a d   D o c u m e n t < / a > < / p >  
                                 ` }  
                         < / d i v >  
                 < / d i v >  
         ` ;  
